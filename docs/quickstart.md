...
----------------------------------------------------------------------------------------------------
1d60b2af-fdb6-421a-96dc-e5e4448142e5  GE-123        created                                       Fix Kafka abandonment fixture
```
...
```
$ bundle exec ruby -I lib bin/work-coordinator send 'GE-123 yes, update the fixture and rerun the suite'
```
...
The `GE-123` prefix is the REF registered in step 1. The coordinator looks up the matching work item and routes the message to the configured tmux pane.
