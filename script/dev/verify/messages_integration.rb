...
begin
  ...
  db.execute(insert_sql, [1, "ai: MS-123 yes update it", base_mac, "msg-guid-1", 0])
  db.execute(insert_sql, [2, "hello world", base_mac + 1_000_000_000, "msg-guid-2", 0])
  db.execute(insert_sql, [3, "ai: MS-456 check status", base_mac + 2_000_000_000, "msg-guid-3", 1])
  db.execute(insert_sql, [4, "ai: MS-456 run tests", base_mac + 3_000_000_000, "msg-guid-4", 0])
  db.close
