...
section "Step 1 — Register work item MS-123"
...
raise "work item not saved" unless found&.external_reference == "MS-123"

pass "work item MS-123 registered (id=wi-1)"
...
section "Step 3 — Receive reply 'MS-123 yes, update the fixture'"

raw_message = "MS-123 yes, update the fixture"
