...
section "Step 1 — Register work item MS-456"
...
work_item = register.call(title: "Kafka fixture check", kind: :jira, external_reference: "MS-456")
...
section "Step 3 — Assert FakeMessageSender received message with [MS-456] prefix"
...
raise "expected body to start with '[MS-456]', got: #{body}" unless body.start_with?("[MS-456]")

pass "Message received with [MS-456] prefix"

section "Step 4 — Verify message format"

expected_body = "[MS-456] Should I update the Kafka fixture?\nReply: MS-456 <your response>"
